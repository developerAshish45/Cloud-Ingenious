...
export default class SrsgSurveyDataSRIC extends LightningElement {
    ...
    @api surveyRec ;
       ...
       @track noteBody ;
        ...
        handleFileUpload(event){
            ...
            this.fieldName = event.currentTarget.dataset.fieldName;
            this.isReachInCase = true;
            if(this.fieldName == 'Reach-In Case 1'){
                this.type = 'MediumTemp';
                this.count = 1;
            }
            if(this.fieldName == 'Reach-In Case 2'){
                this.type = 'MediumTemp';
                this.count = 2;
            }
            if(this.fieldName == 'Reach-In Case 3'){
                this.type = 'MediumTemp';
                this.count = 3;
            }
            if(this.fieldName == 'Low Temp Reach-In Case 1'){
                this.type = 'LowTemp';
                this.count = 1;
            }
            if(this.fieldName == 'Low Temp Reach-In Case 2'){
                this.type = 'LowTemp';
                this.count = 2;
            }
            if(this.fieldName == 'Low Temp Reach-In Case 3'){   
                this.type = 'LowTemp';
                this.count = 3;
            }
            if(this.fieldName == 'Beer Cooler Reach-In Case 1'){
                this.type = 'BeerCooler';
                this.count = 1;
            }
            if(this.fieldName == 'Beer Cooler Reach-In Case 2'){
                this.type = 'BeerCooler';
                this.count = 2;
            }
            if(this.fieldName == 'Beer Cooler Reach-In Case 3'){   
                this.type = 'BeerCooler';
                this.count = 3;
            }
        }

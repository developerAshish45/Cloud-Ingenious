...
import retrieveFiles from '@salesforce/apex/InstallerDetailFormController.retrieveFiles';
export default class AttachmentRelatedList extends LightningElement {
    ...
    /*fetchFileData(parentRecordId){
        console.log('12345' + parentRecordId);
        retrieveFiles({recordId: parentRecordId})
        .then(data=> {
            console.log('data 1234' + data)
            // Sort the file data by insertion time date 03/14/2024
